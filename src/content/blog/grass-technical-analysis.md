...
<pre class="tree-diagram"><code>M_RealisticGrass_01 (主着色器 - 211KB)
│
├── 输入纹理组
...
└── 材质实例
    ...
    └── MI_RealisticGrass_01_LOD1 (20KB)</code></pre>
...
<pre class="tree-diagram"><code>FX_2DWindSyst_Simulation (846KB)
│
├── 粒子发射器
│   ├── 风向控制
│   ├── 风力强度
...
│
└── 输出目标
    └── RT_2DWindSystem_RGBA (6KB)</code></pre>
...
<pre class="flow-diagram"><code>1. Niagara模拟
   ↓
2. 粒子速度场计算
   ↓
...
<pre class="tree-diagram"><code>GrassParametersMapRender/
│
├── 主编辑器
...
└── 笔刷函数
    ...
    └── MF_RT_ScaleBrush (32KB)</code></pre>

### 2. 地形遮罩编辑器

<pre class="tree-diagram"><code>GrassLandscapeMaskRender/
│
├── 主蓝图
...
└── 材质
    ...
    └── M_RT_Composite_SimpleCopy</code></pre>
...
<pre class="flow-diagram"><code>阶段1: 地形准备
├─ 创建Landscape
